...
function updateLocation() {
  ...
  locationElem.innerText = "JAKARTA"; // Replace with your location
}
...
document.addEventListener("keydown", (event) => {
  // Cek apakah event berasal dari keyboard
...
// Menjalankan fungsi redirectHome saat halaman dimuat
window.addEventListener("DOMContentLoaded", redirectHome);

// Fungsi untuk mengarahkan pengguna ke halaman awal (home) dengan efek smooth
function redirectHome() {
  if (window.performance) {
    if (performance.navigation.type === 1) {
      // Redirect hanya jika halaman direfresh
